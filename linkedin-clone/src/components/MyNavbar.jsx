              ...
              <div className="d-flex align-items-center ">
                ...
                <Navbar.Collapse id="navbarScroll">
                  ...
                  >
                    ...
                    <div className="d-flex justify-content-around align-items-center border-end" style={{height:'50px'}}>
                      ...
                      <Nav.Link href="#">
                        <div className="d-flex flex-column align-items-center me-4 ">
                           ...
                           <img src={user[0]?.image} alt="profileImage"
                            className="rounded-pill"
                            width={25}
                            height={25}
                          />
                          <NavDropdown title="tu" id="navbarScrollingDropdown" className="dpdown dropdown-left">
                            <NavDropdown.Item href="#action3" >
                              <div className="d-flex">
                                <p className="fs-1 ">
                                <img src={user[0]?.image} alt="profileImage"  className="rounded-pill"
                            width={55}
                            height={55}/>
                                </p>
                                <div className="d-flex flex-column">
                            ...
                            <NavDropdown.Item href="#action5">
                              ...
                              <NavLink className="p-1 ">
                                <p>
                                  Account per la pubblicazione di offerte di
                                  lavoro
                                </p>
                              </NavLink>
                              <NavLink className="p-1 ">
