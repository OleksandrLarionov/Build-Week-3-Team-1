...
const Suggested = () => {
	...
	return (
		<Row className={params.userId ? 'd-none' : 'd-block elements pb-3'}>
			...
			<Row>
					...
					<Card
						...
						<Card.Body className='d-flex flex-column'>
							...
							<Card.Text className='flex-grow-1 lh-2' style={{ fontSize: '0.8rem' }}>
								Gli utenti che includono almeno una posizione lavorativa ricevono fino a 3,5
				...
				<Col className='col-6'>
					<Card
						...
						<Card.Body className='d-flex flex-column'>
							<Card.Title className='fw-bold' style={{ fontSize: '1.2rem' }}>
								Scrivi un riepilogo per mettere in evidenza la tua personalità o la tua
